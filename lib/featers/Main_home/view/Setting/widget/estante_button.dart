...
class EstanteButton extends StatelessWidget {
  const EstanteButton({super.key,
  ...
  child: GestureDetector(
    onTap: () => method.estantebuttonbt(context),
    child: Row(
...
// Padding EstanteButton(BuildContext context,PageManagments method, iconData, text) => Padding(
//   padding:  EdgeInsets.symmetric(vertical: MediaQuery.of(context).size.height * 0.01),
//   child: GestureDetector(
//     onTap: () => method.estantebuttonbt(context),
//     child: Row(
