...
class SegirancaButton extends StatelessWidget {
  const SegirancaButton({super.key,
  ...
  child: GestureDetector(
    onTap: () => method.segirancabuttonbt(context),
    child: Row(
...
// Padding SegirancaButton(BuildContext context,PageManagments method, iconData, text) => Padding(
//   padding:  EdgeInsets.symmetric(vertical: MediaQuery.of(context).size.height * 0.01),
//   child: GestureDetector(
//     onTap: () => method.segirancabuttonbt(context),
//     child: Row(
